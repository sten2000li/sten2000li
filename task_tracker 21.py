...
def view_tasks(sort_by="priority"):
    ...
    for i, task in enumerate(sorted_tasks, 1):
        ...
        print(f"{i}. [{status}] {task['task']} (категория: {task['category']}, приоритет: {task['priority']}, создано: {task['created_at']}, заметки: {task['notes'] or 'Нет'}, дедлайн: {task['deadline'] or 'Нет'})")
...
def view_incomplete_tasks(sort_by="priority"):
    ...
    if not sorted_tasks:
        ...
        return
    for i, task in enumerate(sorted_tasks, 1):
        print(f"{i}. [ ] {task['task']} (категория: {task['category']}, приоритет: {task['priority']}, создано: {task['created_at']}, заметки: {task['notes'] or 'Нет'}, дедлайн: {task['deadline'] or 'Нет'})")
...
def main():
    ...
    while True:
        ...
        choice = input("Выберите действие (1-11): / Choose an action (1-11): ")
